...
const defaultPosts = [
  ...
  { title: "넷플 추천", content: "요새 볼 게 없음", author: "몽총이", likes: 0, comments: 0, category: "영화" },
  { title: "블랙 미러 비슷한 거 추천해주세요", content: "에피소드 형식 스릴러 장르요", author: "카레먹고싶다", likes: 0, comments: 0, category: "미스테리" },
...
function loadPosts() {
  ...
  return [...defaultPosts, ...savedPosts];
}

// 게시글 초기화
const posts = loadPosts();
const myPosts = posts.filter(post => post.author === "User"); // "내가 쓴 글" 필터링
